...
<body>
	<div id="mainprod">
		<div id="izq">
            ...
            <p id="prod">&Aacute;RIDO SELECCIONADO (70/300)<br/>
            <span class="descr"><p class="parrafo" style="font-weight:bold;">Certificado para:</p>
                    <ul>
                        <li><p class="parrafo">Hormig&oacute;n empleado en pavimentos, carreteras y productos prefabricados de hormig&oacute;n.</p></li>
        ...
        <div id="der">
            <div id="mainimg"><img src="./img/productos/arido70-300.jpg" alt="Arido seleccionado" width="600" height="338" /></div>
        </div>
    </div>
</body>
